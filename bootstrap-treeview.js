...
(function($, window, document, undefined) {
  ...
  Tree.prototype.buildTree = function(nodes, level) {
    ...
    $.each(nodes, function addNodes(id, node) {
      ...
      if (_this.options.showTip && node.def) {
        var template =
          '<div class="tooltip tooltip-top"  role="tooltip"><div class="tooltip-arrow"></div> <div class="tooltip-inner"> </div></div>';
        treeItem.append(
          $(_this.template.tip)
            .attr("title", node.def)
            .tooltip({
  ...
  Tree.prototype.template = {
    ...
    tip:
      '<span class="badge node-tip" data-toggle="tooltip" data-placement="auto right" data-container="body">i</span>'
  };
